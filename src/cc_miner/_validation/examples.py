"""Example usages for the `cc_miner.validation.ValidatingBaseClass` class."""
...
class ActionExample(ValidatingBaseClass):
    """Shows an example usage of the `cc_miner.validation.ValidatingBaseClass` class."""
...
def run_example() -> None:
    """An example usage of the `cc_miner.validation.ValidatingBaseClass` class.
